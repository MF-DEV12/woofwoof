...
$(function(){
	...
	$(".btn-addassets").click(function (e){
		...
		bootbox.confirm("Do you want add this expenses?", function (result){
			if(result){
				param.PROJECTID = projectid;
				callAjaxJson(curCtrl + "insertExpensesToProject",
							 param,
							 function (response){
							 	if(response.result == "ok")
							 		location.href = baseUrl + curCtrl
							 	else
							 		bootbox.alert("The expenses have been already saved.",function(){})
