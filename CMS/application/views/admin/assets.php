...
<body>
					 	...
					 	<div class="panel-group" id="group">
					 	  <?php if($projects) { ?> 
							      ...
							      <h4 class="panel-title">
							      		<div class="btn-group pull-right" data-item='<?=json_encode($row);?>'>
							      			...
							      			<ul class="dropdown-menu" role="menu"> 
									      		<li><a class="btn-view" data-toggle="collapse" data-parent="#group" href="#collapse<?=$row->ID;?>"><span class="glyphicon glyphicon-piggy-bank"></span> Assets</a></li>
							      			</ul> 
							      		</div>
							    ...
							    <div id="collapse<?=$row->ID?>" class="panel-collapse collapse">
							      <div class="panel-body">
							      		<a class="btn btn2 btn-link btn-assets" data-toggle="modal" data-target="#assets-form" data-backdrop="static"  data-keyboard="false" data-item='<?=json_encode($row);?>'><span class="glyphicon glyphicon-plus"></span> Add Assets(s)</a>
	  ...
	  <div class="modal-dialog"> 
	    ...
	    <div class="modal-content" >
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title">Add Assets - <project></project></h4>
	...
	<script type="text/javascript" src='<?=base_url("js/admin/assets.js")?>'></script>
